package com.ddzn.dd.module.app.base;
...
public class BaseController {
    ...
    public Long currentUserId() {
        ...
        UserTokenResult result = tokenUtils.parseUser(token, CommonConstants.MINI_LABEL);
    ...
    public UserTokenResult currentUser() {
        String token = request.getHeader(CommonConstants.TOKEN_KEY);
        return tokenUtils.parseUser(token, CommonConstants.MINI_LABEL);
    }
