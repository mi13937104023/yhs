package com.ddzn.dd.module.system.config;
...
public class Swagger2 {
    ...
    public Docket authApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(authApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ddzn.dd.module.system.controller"))
                .paths(PathSelectors.any())
                .build().globalOperationParameters(setParam()).pathMapping("/system-admin");
    }
    ...
    private ApiInfo authApiInfo() {
        return new ApiInfoBuilder().title("后台管理接口")
                .version("1.0.0")
                .description("后台管理接口")
                .contact(new Contact("", "", ""))
                .termsOfServiceUrl("")
